...
public class IndexingServer_Auto_Concurrent {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            new ServerThread_Auto_Concurrent(clientID, newConnection).start();
            System.out.println("New Connection Accepted. Client ID: " + clientID);
            clientID = clientID + 1;
        }
    }

    private static class ServerThread_Auto_Concurrent extends Thread {
        ...
        public ServerThread_Auto_Concurrent(int clientID, Socket connection) {
