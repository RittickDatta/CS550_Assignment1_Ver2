...
public class Peer_Auto_2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            PEER_SERVER_PORT = Integer.parseInt("4001");//Integer.parseInt(userInput.readLine());
            ...
            PEER_CLIENT_FILE_LOCATION = "Node2";//userInput.readLine();
            System.out.println();
            ...
            System.out.println();
            new Peer_Auto_2.PeerClient_2(serverAddress, 3000, PEER_CLIENT_FILE_LOCATION, PEER_SERVER_PORT).start();

            //-----------------------------------------------------

            while (true) {
                Socket newConnection = peerServer.accept();
                new Peer_Auto_2.PeerServer_2(clientID, newConnection).start();
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static class PeerClient_2 extends Thread {
        ...
        public PeerClient_2(InetAddress serverAddress, int serverPort, String peerFileLocation, int peerServerPort) {
    ...
    private static class PeerServer_2 extends Thread {
        ...
        public PeerServer_2(int clientId, Socket connection) {
